...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BAS_CLIENT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BAS_CLIENT_LOG_LEVEL_INF, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BAS_CLIENT_LOG_LEVEL, 3);
